...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String input_1Str = "1.bmp";
        final String input_2Str = "2.jpg";
        final FImage input_1 = ImageUtilities.readF(App.class.getClassLoader().getResourceAsStream(input_1Str));
        final FImage input_2 = ImageUtilities.readF(App.class.getClassLoader().getResourceAsStream(input_2Str));

        // Prepare the engine to the parameters in the IPOL demo
        final ASIFTEngine engine = new ASIFTEngine(false, 1);
    ...
    private static LocalFeatureMatcher<Keypoint> createConsistentRANSACHomographyMatcher() {
        final ConsistentLocalFeatureMatcher2d<Keypoint> matcher = new ConsistentLocalFeatureMatcher2d<Keypoint>(createFastBasicMatcher());
